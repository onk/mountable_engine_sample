...
ActiveRecord::Schema.define(version: 20141201111931) do
  ...
  create_table "my_engine_articles", force: true do |t|
    t.integer  "user_id"
    t.text     "body"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  add_index "my_engine_articles", ["user_id"], name: "index_my_engine_articles_on_user_id", using: :btree
